...
`scripts/mobile-ui-playtest.mjs` passes six Chrome viewport layouts: 320×568, 360×640, 390×844, 667×375, 844×390 and 1280×800. `ui/report.json` records 54 card checks across all eight upgrade types, no art/text overlaps or horizontal overflow, and five high-health/shield HUD fixtures. The owner agent visually inspected the portrait effects, small loaded HUD, landscape and desktop captures.
