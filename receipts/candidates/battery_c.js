// Candidate C, constructed from receipts/references/battery.png.
export default function generate(THREE) {
  ...
  profile([[-0.14,0],[-0.2,0.08],[-0.2,0.4],[-0.12,0.48],[0.12,0.48],[0.2,0.4],[0.2,0.08],[0.14,0]],0.28,lime,0,0.05,-0.14);
  ...
  g.scale.setScalar(0.6/(bounds.max.y-bounds.min.y));return g;
}
