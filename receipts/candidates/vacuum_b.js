// Candidate B, constructed from receipts/references/vacuum.png.
export default function generate(THREE) {
  ...
  lathe([[0,0],[0.24,0],[0.31,0.06],[0.34,0.17],[0.34,0.47],[0.3,0.52],[0,0.52]],cream,0,0.23,0);cyl(0.35,0.35,0.07,red,0,0.7,0);
