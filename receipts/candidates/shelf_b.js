// Candidate B, constructed from receipts/references/shelf.png.
export default function generate(THREE) {
  ...
  for(const x of [-0.96,0.96]){const o=profile([[-0.78,0],[-0.78,1.36],[0.78,1.36],[0.78,0],[0.68,0],[0.68,1.26],[-0.68,1.26],[-0.68,0]],0.07,cream,0,0,0);o.rotation.y=Math.PI/2;o.position.x=x;}for(const y of [0.13,0.52,0.91,1.33])box(1.95,0.06,1.52,cream,0,y,0);
