// Candidate B, constructed from receipts/references/security_trolley.png.
export default function generate(THREE) {
  ...
  for(const side of [-1,1]){profile([[-0.33,0],[-0.4,0.38],[0.4,0.38],[0.33,0]],0.03,red,0,0.53,side*0.38);for(let i=0;i<5;i++)box(0.04,0.27,0.01,dark,-0.24+i*0.12,0.74,side*0.405);}for(const x of [-0.4,0.4])box(0.035,0.4,0.74,red,x,0.74,0);box(0.73,0.045,0.75,red,0,0.53,0);
