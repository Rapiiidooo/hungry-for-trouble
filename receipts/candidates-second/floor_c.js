// Candidate C, constructed from receipts/references/floor.png.
export default function generate(THREE) {
  ...
  box(2,0.065,2,grout,0,0.0325,0);for(const x of [-0.49,0.49])for(const z of [-0.49,0.49])mesh(new THREE.BoxGeometry(0.97,0.045,0.97,2,1,2),tile,x,0.087,z);
