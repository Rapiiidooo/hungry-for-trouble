// Candidate A, constructed from receipts/references/checkout.png.
export default function generate(THREE) {
  ...
  box(0.88,0.69,1.37,red,-0.40,0.38,0);box(0.92,0.10,1.45,cream,-0.4,0.78,0);box(0.74,0.03,1.26,dark,-0.4,0.845,0);
