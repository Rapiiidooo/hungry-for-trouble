// Candidate C, constructed from receipts/references/freezer.png.
export default function generate(THREE) {
  ...
  for(const side of [-1,1]){box(0.94,0.83,1.5,teal,side*0.49,0.53,0);box(0.84,0.04,1.36,dark,side*0.49,0.97,0);}box(0.045,0.89,1.51,cream,0,0.55,0);
