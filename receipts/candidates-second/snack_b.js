// Candidate B, constructed from receipts/references/snack.png.
export default function generate(THREE) {
  ...
  const o=profile([[-0.086,-0.048],[-0.088,-0.002],[-0.025,0.092],[0.025,0.09],[0.087,-0.014],[0.074,-0.058],[0,-0.081]],0.074,crumb,0,0.046,0,g,0.018);o.rotation.x=-Math.PI/2;for(const x of [-0.036,0.033])sphere(0.019,toast,x,0.115,-0.019);
