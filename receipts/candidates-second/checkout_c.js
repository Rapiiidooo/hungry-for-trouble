// Candidate C, constructed from receipts/references/checkout.png.
export default function generate(THREE) {
  ...
  for(const z of [-0.48,0.48])box(0.78,0.67,0.28,red,-0.4,0.37,z);for(const x of [-0.85,0.03])box(0.075,0.08,1.4,cream,x,0.78,0);for(let i=0;i<12;i++){const roller=cyl(0.053,0.053,0.76,dark,-0.4,0.79,-0.59+i*0.106);roller.rotation.z=Math.PI/2;}
