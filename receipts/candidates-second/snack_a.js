// Candidate A, constructed from receipts/references/snack.png.
export default function generate(THREE) {
  ...
  for(let i=0;i<3;i++){const a=i*Math.PI*2/3;const o=sphere(0.069,crumb,Math.sin(a)*0.043,0.064,Math.cos(a)*0.043);o.scale.y=0.8;}sphere(0.06,crumb,0,0.072,0);
