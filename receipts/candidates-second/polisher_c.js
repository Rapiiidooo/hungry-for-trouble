// Candidate C, constructed from receipts/references/polisher.png.
export default function generate(THREE) {
  ...
  const p=profile([[-0.4,-0.33],[-0.47,-0.15],[-0.47,0.22],[-0.28,0.5],[0.28,0.5],[0.47,0.22],[0.47,-0.15],[0.4,-0.33]],0.12,teal,0,0.24,0);p.rotation.x=Math.PI/2;profile([[-0.25,0],[-0.18,0.28],[0.18,0.28],[0.25,0]],0.37,cream,0,0.28,-0.22);
