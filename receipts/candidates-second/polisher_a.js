// Candidate A, constructed from receipts/references/polisher.png.
export default function generate(THREE) {
  ...
  const base=cyl(0.44,0.47,0.13,teal,0,0.20,0);base.scale.z=1.12;const bumper=cyl(0.46,0.47,0.055,dark,0,0.15,0);bumper.scale.z=1.12;cyl(0.19,0.26,0.27,cream,0,0.39,-0.03);
