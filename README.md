...
The [official public phone/4G verdict](receipts/verification-visual-finish-release/jam/verdict.txt) passes for submitted gameplay commit `d3189497996019ce2f836779f614096589b9d5c3`: 2.0-second readiness, 3.5 MB, 8.7 metres of real touch movement, no errors and no external dependency. It covers the opening aisle in Chrome phone emulation, with separate campaign and feature evidence above.
