...
The latest build passes 39 Node checks, the official 37-module shipping check and real desktop/phone navigation probes. [Onboarding evidence](receipts/verification-onboarding/README.md) covers briefing timing, reduced initial ammunition, basic-gear restarts and the real daily board. The official local phone/4G gate passes for gameplay commit `df414d1621fb164e49a1e9a09ba846304623afc7`: 5.6-second readiness, 2.7 MB, real touch movement and no errors. Its [unedited verdict](receipts/verification-onboarding/jam/verdict.txt) covers the opening aisle on Chrome phone emulation; the live-URL gate remains outstanding. Earlier campaign, finale and multiplayer evidence remains in [the preceding receipts](receipts/verification-reveal/README.md).
