...
The [official public phone/4G verdict](receipts/verification-mobile-controls/jam/verdict.txt) passes for submitted gameplay commit `c2cf443402a7e5e91207d92809aae00e5d59be21`: 2.1-second readiness, 3.5 MB, 8.7 metres of real touch movement and no errors. It covers the opening aisle in Chrome phone emulation, with separate campaign and feature evidence above.
