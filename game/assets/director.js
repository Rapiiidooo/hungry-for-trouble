// Candidate b: receipts/references/director.png
export default function generate(THREE) {
 ...
 profile([[-.46,0],[-.51,.12],[-.48,1.21],[-.38,1.38],[.38,1.38],[.48,1.21],[.51,.12],[.46,0]],.64,cream,0,.4,-.36);profile([[-.45,0],[-.45,.39],[-.35,.53],[.35,.53],[.45,.39],[.45,0]],.56,cream,0,.4,.25);
