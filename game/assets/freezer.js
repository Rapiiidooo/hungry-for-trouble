// Candidate B, constructed from receipts/references/freezer.png.
export default function generate(THREE) {
  ...
  profile([[-0.94,0],[-1,0.12],[-1,0.7],[-0.88,0.84],[0.88,0.84],[1,0.7],[1,0.12],[0.94,0]],1.45,teal,0,0.1,-0.725);box(1.78,0.03,1.3,dark,0,0.96,0);
