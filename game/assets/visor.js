// Candidate b: receipts/references/visor.png
export default function generate(THREE) {
 ...
 for(const s of [-1,1]){const o=lathe([[0,0],[.2,0],[.25,.05],[.25,.22],[.21,.29],[0,.29]],cream,s*.25,.3,-.14);o.rotation.x=Math.PI/2;}
 ...
 g.scale.setScalar(0.65/(bounds.max.y-bounds.min.y));return g;
}
